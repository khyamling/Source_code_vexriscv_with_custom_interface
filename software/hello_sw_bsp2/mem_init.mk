...
# Memory: ocram_64K
MEM_0 := soc_system_ocram_64K
$(MEM_0)_NAME := ocram_64K
...
$(MEM_0)_HIERARCHICAL_PATH := ocram_64K
$(MEM_0)_WIDTH := 32
...
.PHONY: ocram_64K
ocram_64K: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
