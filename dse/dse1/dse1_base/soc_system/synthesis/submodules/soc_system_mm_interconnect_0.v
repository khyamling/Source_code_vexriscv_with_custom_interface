...
module soc_system_mm_interconnect_0 (
	...
	wire  [106:0] ocram_64k_s1_agent_rf_source_data;                                  // ocram_64K_s1_agent:rf_source_data -> ocram_64K_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] ocram_64k_s1_agent_rsp_fifo_out_data;                               // ocram_64K_s1_agent_rsp_fifo:out_data -> ocram_64K_s1_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                              // cmd_mux_001:src_valid -> ocram_64K_s1_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> ocram_64K_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                              // ocram_64K_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> ocram_64K_s1_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                      // cmd_mux_001:src_startofpacket -> ocram_64K_s1_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                        // cmd_mux_001:src_endofpacket -> ocram_64K_s1_agent:cp_endofpacket
	...
	wire  [106:0] ocram_16b_s1_agent_rf_source_data;                                  // ocram_16b_s1_agent:rf_source_data -> ocram_16b_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] ocram_16b_s1_agent_rsp_fifo_out_data;                               // ocram_16b_s1_agent_rsp_fifo:out_data -> ocram_16b_s1_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                              // cmd_mux_002:src_valid -> ocram_16b_s1_agent:cp_valid
	wire  [105:0] cmd_mux_002_src_data;                                               // cmd_mux_002:src_data -> ocram_16b_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                              // ocram_16b_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                            // cmd_mux_002:src_channel -> ocram_16b_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                      // cmd_mux_002:src_startofpacket -> ocram_16b_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                        // cmd_mux_002:src_endofpacket -> ocram_16b_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_005_src_valid;                                              // cmd_mux_005:src_valid -> switch_pio_s1_agent:cp_valid
	wire  [105:0] cmd_mux_005_src_data;                                               // cmd_mux_005:src_data -> switch_pio_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                              // switch_pio_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                            // cmd_mux_005:src_channel -> switch_pio_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                      // cmd_mux_005:src_startofpacket -> switch_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                        // cmd_mux_005:src_endofpacket -> switch_pio_s1_agent:cp_endofpacket
	...
	wire  [105:0] sysid_qsys_0_control_slave_agent_rp_data;                           // sysid_qsys_0_control_slave_agent:rp_data -> router_001:sink_data
	...
	wire          ocram_64k_s1_agent_rp_valid;                                        // ocram_64K_s1_agent:rp_valid -> router_002:sink_valid
	wire  [105:0] ocram_64k_s1_agent_rp_data;                                         // ocram_64K_s1_agent:rp_data -> router_002:sink_data
	wire          ocram_64k_s1_agent_rp_ready;                                        // router_002:sink_ready -> ocram_64K_s1_agent:rp_ready
	wire          ocram_64k_s1_agent_rp_startofpacket;                                // ocram_64K_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          ocram_64k_s1_agent_rp_endofpacket;                                  // ocram_64K_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          ocram_16b_s1_agent_rp_valid;                                        // ocram_16b_s1_agent:rp_valid -> router_003:sink_valid
	wire  [105:0] ocram_16b_s1_agent_rp_data;                                         // ocram_16b_s1_agent:rp_data -> router_003:sink_data
	wire          ocram_16b_s1_agent_rp_ready;                                        // router_003:sink_ready -> ocram_16b_s1_agent:rp_ready
	wire          ocram_16b_s1_agent_rp_startofpacket;                                // ocram_16b_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          ocram_16b_s1_agent_rp_endofpacket;                                  // ocram_16b_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          switch_pio_s1_agent_rp_valid;                                       // switch_pio_s1_agent:rp_valid -> router_006:sink_valid
	wire  [105:0] switch_pio_s1_agent_rp_data;                                        // switch_pio_s1_agent:rp_data -> router_006:sink_data
	wire          switch_pio_s1_agent_rp_ready;                                       // router_006:sink_ready -> switch_pio_s1_agent:rp_ready
	wire          switch_pio_s1_agent_rp_startofpacket;                               // switch_pio_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          switch_pio_s1_agent_rp_endofpacket;                                 // switch_pio_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          ocram_64k_s1_agent_rdata_fifo_src_valid;                            // ocram_64K_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] ocram_64k_s1_agent_rdata_fifo_src_data;                             // ocram_64K_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          ocram_64k_s1_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> ocram_64K_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                  // avalon_st_adapter_001:out_0_valid -> ocram_64K_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                   // avalon_st_adapter_001:out_0_data -> ocram_64K_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                  // ocram_64K_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                  // avalon_st_adapter_001:out_0_error -> ocram_64K_s1_agent:rdata_fifo_sink_error
	wire          ocram_16b_s1_agent_rdata_fifo_src_valid;                            // ocram_16b_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] ocram_16b_s1_agent_rdata_fifo_src_data;                             // ocram_16b_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          ocram_16b_s1_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_002:in_0_ready -> ocram_16b_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                  // avalon_st_adapter_002:out_0_valid -> ocram_16b_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                   // avalon_st_adapter_002:out_0_data -> ocram_16b_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                  // ocram_16b_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                  // avalon_st_adapter_002:out_0_error -> ocram_16b_s1_agent:rdata_fifo_sink_error
	...
	wire          switch_pio_s1_agent_rdata_fifo_src_valid;                           // switch_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] switch_pio_s1_agent_rdata_fifo_src_data;                            // switch_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          switch_pio_s1_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_005:in_0_ready -> switch_pio_s1_agent:rdata_fifo_src_ready
	...
	soc_system_mm_interconnect_0_router_001 router_004 (
	...
	soc_system_mm_interconnect_0_router_001 router_006 (
